...
//    ui->Amperage->display(amperage_dc);
    ...
    ready *= table2.sl1;  //2.0 уровень масла в норме
    ready *= table2.sp1;  //2.5 фильтр всасывающий М1 загрязнен
    ready *= table2.sp2;  //2.6 фильтр всасывающий М2 загрязнен
    ready *= table2.sp3;  //2.7 фильтр всасывающий М3
    ready *= table2.sp4;  //3.0 фильтр всасывающий М3
    ready *= table2.sp5;  //3.1 фильтр всасывающий М4 загрязнен
    ready *= table2.sp6;  //3.2 фильтр всасывающий М5 загрязнен
    ready *= table2.sp7;  //3.3 фильтр тонкой очистки М1 загрязнен
    ready *= table2.sp8;  //3.4 фильтр грубой очистки М1 загрязнен
    ready *= table2.sp9;  //3.5 фильтр тонкой очистки М2 загрязнен
    ready *= table2.sp10;     //3.6 фильтр грубой очистки М2 загрязнен
    ready *= table2.sp11;     //3.7 фильтр тонкой очистки М4 загрязнен
    ready *= table2.sp12;     //4.0 фильтр грубой очистки М3
    ready *= table2.sp13;     //4.1 фильтр грубой очистки М3
    ready *= table2.sp14;     //4.2 фильтр контура охлаждения загрязнен
    ready *= table2.sp15;     //4.3 фильтр тонкой очистки М12 загрязнен
    ready *= table2.sq1;  //4.4 кран М1 закрыт
    ready *= table2.sq3;  //4.5 кран М2 закрыт
    ready *= table2.sq5;  //4.6 кран М3
    ready *= table2.sq7;  //4.7 кран М3
    ready *= table2.sq9;  //5.0 кран М4 закрыт
    ready *= table2.sq11;     //5.1 кран М5 закрыт
    ready *= table2.sq13;     //5.2 кран дренажа М1 закрыт
    ready *= table2.sq14;     //5.3 кран дренажа М2 закрыт
    ready *= table2.sq15;     //5.4 кран дренажа М4 закрыт
