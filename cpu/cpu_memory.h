...
public:
    ...
    data::DB82R DB82R;    //настройки ручного режима

    data::DB90 DB90;    //массивы значений для теста 10
    data::M2   M2;      //управляющие биты автомат режима тест насосов
    data::M3   M3;      //управляющие биты
    data::M4   M4;      //start/stop контроля чистоты раб жидкости
