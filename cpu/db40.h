...
public:
    ...
    bool& BP1_Err; //Обрыв/неиспр-сть датчика давления после М1/М2
    bool& BP2_Err; //Обрыв/неиспр-сть датчика давления на сливе испытуемого аппарата
    bool& BP3_Err; //Обрыв/неиспр-сть датчика давления в полости А
    bool& BP4_Err; //Обрыв/неиспр-сть датчика давления в полости В
    bool& BP5_Err; //Обрыв/неиспр-сть датчика давления в полости Р
    bool& BP6_Err; //Обрыв/неиспр-сть датчика давления в полости Х
    bool& BT1_Err; //Обрыв/неиспр-сть датчика температуры масла в баке 1
    bool& BV1_Err; //Обрыв/неиспр-сть датчика расхода в полости Р (0-60л/мин)
    bool& BV2_Err; //Обрыв/неиспр-сть датчика расхода в полости Р (60-1000л/мин)
    bool& BV3_Err; //Обрыв/неиспр-сть датчика расхода утечек (0,5-25л/мин)
...
//    float mFloatData[ FLOAT_COUNT ];
    ...
    wchar_t const* mAdresses[ BOOL_COUNT + FLOAT_COUNT ] = {
       ...
       L"CPU/DB40.BP1_Err", //Обрыв/неиспр-сть датчика давления после М1/М2
       L"CPU/DB40.BP2_Err", //Обрыв/неиспр-сть датчика давления на сливе испытуемого аппарата
       L"CPU/DB40.BP3_Err", //Обрыв/неиспр-сть датчика давления в полости А
       L"CPU/DB40.BP4_Err", //Обрыв/неиспр-сть датчика давления в полости В
       L"CPU/DB40.BP5_Err", //Обрыв/неиспр-сть датчика давления в полости Р
       L"CPU/DB40.BP6_Err", //Обрыв/неиспр-сть датчика давления в полости Х
       L"CPU/DB40.BT1_Err", //Обрыв/неиспр-сть датчика температуры масла в баке 1
       L"CPU/DB40.BV1_Err", //Обрыв/неиспр-сть датчика расхода в полости Р (0-60л/мин)
       L"CPU/DB40.BV2_Err", //Обрыв/неиспр-сть датчика расхода в полости Р (60-1000л/мин)
       L"CPU/DB40.BV3_Err", //Обрыв/неиспр-сть датчика расхода утечек (0,5-25л/мин)
